-- continuing off from the data cleaning project, 
-- we have a dataset of employees laid off in and around covid
-- Here we are going to explore the data and find trends 
-- ,patterns or anything interesting like outliers
